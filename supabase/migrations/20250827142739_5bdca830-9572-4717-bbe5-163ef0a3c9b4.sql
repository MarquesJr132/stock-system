...
ALTER TABLE public.profiles DROP POLICY IF EXISTS "Users can update own profile only";
ALTER TABLE public.profiles DROP POLICY IF EXISTS "Administrators can update tenant user profiles";
