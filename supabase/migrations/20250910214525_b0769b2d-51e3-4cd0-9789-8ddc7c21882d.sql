-- First drop the function to avoid return type conflicts
DROP FUNCTION public.get_tenant_limits_with_admin_info();
...
-- Recreate the get_tenant_limits_with_admin_info function with new column names
